    ...
    <footer className={styles.footer}>
      <div className={styles.footer__container}>
        <div className={`${styles.footer__section} ${styles.footer__section_top}`}>
          <div className={styles.footer__contacts}>
            ...
            <span className={styles.footer__contact}>
              ...
              <p className={styles.footer__text}>info@CodeQuest.com</p>
            </span>
            <span className={styles.footer__contact}>
              <img className={styles.footer__icon} src={Vector6} alt="" />
              <p className={styles.footer__text}>Создаём уникальные игровые миры, где идеи становятся интерактивной реальностью.</p>
            </span>
          </div>
          <div className={styles.footer__links}>
            <span className={styles.footer__list_container}>
              <ul className={styles.footer__list}>
                <li><a href="#about" className={styles.footer__link}>О студии</a></li>
                <li><a href="#services" className={styles.footer__link}>Предложения</a></li>
        ...
        <div className={`${styles.footer__section_bottom}`}>
          <p className={styles.footer__copyright}> &copy;  2025  CodeQuest <i><b> Все права защищены. </b></i></p>
